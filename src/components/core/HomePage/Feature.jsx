  ...
  return (
    <section className="relative not-prose scroll-mt-[72px] text-white mt-[80px]" id="features">
        ...
        <div className="text-center md:mx-auto mb-8 md:mb-12 max-w-3xl">
            ...
            <h2 className="font-bold font-heading leading-tighter tracking-tighter text-heading md:text-4xl text-3xl">What you get with Institue name</h2>
            <p className="text-xl mt-3 text-richblack-25 w-[90vw] mx-auto">Institue offers a cutting-edge platform for education, designed with top-notch features and exceptional user experience.</p>
        </div>

        <div className="grid md:gap-y-12 sm:grid-cols-2">
            {featuresData.items.map((item, index) => (
                  <div>
                    <div key={index} className="flex flex-row max-w-md mx-auto w-[60vw]">
                        <div>
